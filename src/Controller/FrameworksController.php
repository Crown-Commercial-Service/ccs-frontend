...
class FrameworksController extends AbstractController
{
    ...
    public function upcomingDealsSearch(Request $request)
    {
        ...
        $checkedStatuses = $this->controllerHelper->getArrayFromStringForParam($request, "statuses", "allAgreementStatus");
        $checkedTypes = $this->controllerHelper->getArrayFromStringForParam($request, "type", "allAgreementType");
    ...
    {
        $checkedTypeArray = $this->controllerHelper->getArrayFromStringForParam($request, "type");
    ...
    public function show(string $rmNumber, Request $request)
    {
       ...
       $content_group = "agreement/" . ControllerHelper::toSlug($results->getContent()["category"]->getValue());
        ...
        $data = [
            ...
            'youtubeVideo'  => $this->controllerHelper->getYoutubeVideo()
        ];
    ...
    public function suppliersOnLotCsv(Request $request, string $rmNumber, string $lotNumber)
    {
        ...
        $response->headers->set('Content-Disposition', 'attachment; filename="' . $rmNumber . '_Lot' . $lotNumber . '.csv' . '";');
