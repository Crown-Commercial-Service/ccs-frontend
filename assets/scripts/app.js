...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (cardLists != null) {
        ...
        var dropdownItems = document.querySelectorAll('.nav-list__item.has-dropdown');
        dropdownItems.forEach(function (item) {
            ...
            item.addEventListener('mouseenter', function () {
                ...
                dropdownItems.forEach(function (otherItem) {
                    if (otherItem !== item) {
                        var otherDropdown = otherItem.querySelector('.dropdown-menu');
                        if (otherDropdown) {
        ...
        // Mobile-specific click functionality
        function addMobileClickHandlers() {
            if (window.innerWidth <= 768) {
                dropdownItems.forEach(function (item) {
                    ...
                    navLink.removeEventListener('click', handleMobileClick);

                    // Add mobile click handler
                    navLink.addEventListener('click', handleMobileClick);

                    function handleMobileClick(e) {
                        e.preventDefault();

                        // Allow multiple dropdowns open on mobile
                        if (dropdown) {
        ...
        // Add mobile click handlers on load and resize
        addMobileClickHandlers();
        window.addEventListener('resize', addMobileClickHandlers);
