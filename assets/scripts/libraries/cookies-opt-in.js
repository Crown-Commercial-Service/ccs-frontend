...
<fieldset class="govuk-fieldset" aria-describedby="${datarecord.cookie_type}-hint">
    ...
    function createCookieMessage() {
        ...
        cookieMessageInner.innerHTML = '<div class="govuk-heading-m">Cookies on crowncommercial.gov.uk</div><div class="cookie-message__intro"><p>We use cookies to collect information about how you use crowncommercial.gov.uk.<br><br> We use this information to make the website work as well as possible and improve government services.</p></div>';
